...
def compute_ppo_loss(
  ...
  #######################
  # n.b. what are [T,B]? [50,128]? 'rewards generated by following behaviour policy'? 
  print('***\nMaking rewards:\n')
  print('data.rewards: ', data.rewards, '\n')
  print('agent_index: ', agent_index, '\n')
  print('reward_scaling: ', reward_scaling, '\n')
  print('rewards: ', data.rewards[1:, ..., agent_index] * reward_scaling)
  print('***\n')
  #######################
